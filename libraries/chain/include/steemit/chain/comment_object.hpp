...
FC_REFLECT(steemit::chain::comment_object,
        (id)(author)(permlink)
                ...
                (total_vote_weight)(cashout_windows_amount)(reward_weight)(total_payout_value)(curator_payout_value)(beneficiary_payout_value)(author_rewards)(net_votes)(root_comment)(mode)
