...
namespace steemit {
    namespace app {
        ...
        struct discussion_index {
            ...
            vector<string> payout;    /// pending lifetime payout
...
FC_REFLECT(steemit::app::discussion_index, (category)(trending)(payout)(trending30)(updated)(created)(responses)(active)(votes)(maturing)(best)(hot)(promoted)(cashout))
