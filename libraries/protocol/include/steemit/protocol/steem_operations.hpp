...
namespace steemit {
    namespace protocol {
        ...
        class comment_payout_extend_operation : public comment_base_operation {
        public:
        ...
        class delete_comment_operation : public comment_base_operation {
        public:
            void validate() const;
...
FC_REFLECT(steemit::protocol::comment_options_operation, (author)(permlink)(max_accepted_payout)(percent_steem_dollars)(payout_extension_payment)(allow_votes)(allow_curation_rewards)(extensions))
