...
#define STEEMIT_CASHOUT_WINDOW_SECONDS          (60*15) /// 1 hour
...
#define STEEMIT_VESTING_WITHDRAW_INTERVALS_PRE_HF_17 13
...
#define STEEMIT_POST_MAX_BANDWIDTH_PRE_HF_17    (4*STEEMIT_100_PERCENT) // 2 posts per 1 days, average 1 every 12 hours
#define STEEMIT_POST_WEIGHT_CONSTANT_PRE_HF_17  (uint64_t(STEEMIT_POST_MAX_BANDWIDTH_PRE_HF_17) * STEEMIT_POST_MAX_BANDWIDTH_PRE_HF_17)
#define STEEMIT_POST_MAX_BANDWIDTH              (8*STEEMIT_100_PERCENT) // 2 posts per 1 days, average 1 every 12 hours
