...
namespace steemit {
    namespace example_plugin {
        ...
        class hello_api_plugin : public steemit::application::plugin {
        public:
            /**
             ...
             */
            hello_api_plugin(steemit::application::application *app);
        ...
        class hello_api_api {
        public:
            hello_api_api(const steemit::application::api_context &ctx);
...
namespace steemit {
    namespace example_plugin {
        ...
        hello_api_plugin::hello_api_plugin(steemit::application::application *app)
        ...
        hello_api_api::hello_api_api(const steemit::application::api_context &ctx)
                : _app(ctx.app) {
        }
        ...
        std::string hello_api_api::get_message() {
            ...
            result << plug->get_message() << " -- you've viewed this message "
